rule HackTool_Webshell_ASP_Godzilla_v3_03_ASP_Runtime_Compile_Webshell
{
	meta:
        	// 规则创建时间
		...
		// 规则匹配的样本的MD5
		md5 = "a34a8c0acdca6e93d16c21482270f904"
		// 修改完一次 加一
		rev = 1
		...
		threatname="HackTool[Webshell]/ASP.Godzilla.v3_03_ASP_Runtime_Compile_Webshell"
	strings:
